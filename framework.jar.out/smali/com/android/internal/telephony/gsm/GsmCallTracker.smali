...
.method declared-synchronized dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    .line 243
    .end local v1           #isDialRequestPending:Z
    :catchall_0
    move-exception v2
    ...
    .line 264
    .restart local v1       #isDialRequestPending:Z
    :cond_0
    :try_start_1
    iget-object v2, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->foregroundCall:Lcom/android/internal/telephony/gsm/GsmCall;
    ...
    iput-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->hangupPendingMO:Z
    ...
    const-string v4, "dial emergencyCat : "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1343
    .local v11, conn:Lcom/android/internal/telephony/gsm/GsmConnection;
    if-eqz v13, :cond_a
    ...
    invoke-virtual {v11}, Lcom/android/internal/telephony/gsm/GsmConnection;->getAddress()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v11}, Lcom/android/internal/telephony/gsm/GsmConnection;->getCreateTime()J

    move-result-wide v4

    invoke-virtual {v11}, Lcom/android/internal/telephony/gsm/GsmConnection;->getDurationMillis()J

    move-result-wide v6

    invoke-virtual {v11}, Lcom/android/internal/telephony/gsm/GsmConnection;->isIncoming()Z
    ...
    :cond_7
    :goto_5
    invoke-virtual {v11, v10}, Lcom/android/internal/telephony/gsm/GsmConnection;->onRemoteDisconnect(I)V
    ...
    .end local v11           #conn:Lcom/android/internal/telephony/gsm/GsmConnection;
    .end local v12           #i:I
    .end local v13           #isDroppedCall:Z
    .end local v15           #s:I
    :cond_8
    ...
    .line 1329
    .restart local v13       #isDroppedCall:Z
    ...
    .line 1347
    .end local v14           #loc:Landroid/telephony/gsm/GsmCellLocation;
    .restart local v11       #conn:Lcom/android/internal/telephony/gsm/GsmConnection;
    ...
    .line 1348
    invoke-virtual {v11}, Lcom/android/internal/telephony/gsm/GsmConnection;->getConnectTime()J
    ...
    .line 1350
    iget-object v1, v11, Lcom/android/internal/telephony/gsm/GsmConnection;->dialString:Ljava/lang/String;
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v3, "poll: conn[i="
    ...
    const-string/jumbo v3, "poll: pendingMO="
