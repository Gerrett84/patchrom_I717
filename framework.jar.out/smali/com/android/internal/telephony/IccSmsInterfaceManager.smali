...
# static fields
.field private static final AREAMAIL_ENABLE_TEST_ID:Z = false

.field protected static final DBG:Z = true

.field private static final EVENT_LOAD_DONE:I = 0x1

.field private static final EVENT_LOAD_ONE_DONE:I = 0x5
...
.field private static final MESSAGE_ID_AREAMAIL_TEST:I = 0x1103
...
.field private static mHasTestIdSet:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mHasTestIdSet:Z
...
.method static synthetic access$400(Lcom/android/internal/telephony/IccSmsInterfaceManager;)[B
    .locals 1
    .parameter "x0"

    .prologue
    .line 62
    iget-object v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mSmsPdu:[B

    return-object v0
.end method

.method static synthetic access$402(Lcom/android/internal/telephony/IccSmsInterfaceManager;[B)[B
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 62
    iput-object p1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mSmsPdu:[B
...
.method private setForcedChannelCbOn(IIZ)Z
    .locals 7
    ...
    .line 866
    new-array v6, v5, [Lcom/android/internal/telephony/gsm/SmsBroadcastConfigInfo;
    ...
    .line 870
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->setCellBroadcastConfig([Lcom/android/internal/telephony/gsm/SmsBroadcastConfigInfo;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p3}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->setCellBroadcastActivation(Z)Z
...
.method public declared-synchronized disableCellBroadcastRange(II)Z
    ...
    :try_start_0
    const-string v3, "disableCellBroadcastRange"
    ...
    .line 818
    const-string/jumbo v2, "setForcedChannelCbOn(false)"
    ...
    invoke-direct {p0, p1, p2, v2}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->setForcedChannelCbOn(IIZ)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getMessagesFromIccEf(I)[B
    ...
    .prologue
    .line 393
    const-string v4, "getMessagesFromEF"
    ...
    invoke-virtual {v2, v4, p1, v3}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixed(IILandroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v6, "getMessagesFromIccEf = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mSmsPdu:[B
    ...
    const-string v6, "[SimSmsInterfaceManager] getMessagesFromIccEf = "
    ...
    .line 418
    iget-object v4, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mSmsPdu:[B
...
.method public setCDMASmsReassembly(Z)V
    ...
    const-string/jumbo v1, "setCDMASmsReassembly"
