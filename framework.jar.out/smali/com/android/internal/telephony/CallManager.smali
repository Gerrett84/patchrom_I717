...
.field private mAudioFocusForCall:Z
...
.method private constructor <init>()V
    ...
    .line 156
    iput-boolean v2, p0, Lcom/android/internal/telephony/CallManager;->mAudioFocusForCall:Z
    ...
    .line 2318
    iput-boolean v2, p0, Lcom/android/internal/telephony/CallManager;->isDisconnectSilent:Z

    .line 2319
    iput-boolean v2, p0, Lcom/android/internal/telephony/CallManager;->isIMSDisconnectSilent:Z

    .line 2320
    iput v2, p0, Lcom/android/internal/telephony/CallManager;->m606RetryCount:I
...
.method public setAudioMode()V
    ...
    .line 647
    .restart local v7       #useInCallMode:Z
    :cond_3
    invoke-direct {p0}, Lcom/android/internal/telephony/CallManager;->getContext()Landroid/content/Context;
    ...
    .line 655
    .local v0, audioManager:Landroid/media/AudioManager;
    sget-object v8, Lcom/android/internal/telephony/CallManager$2;->$SwitchMap$com$android$internal$telephony$Phone$State:[I

    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->getState()Lcom/android/internal/telephony/Phone$State;

    move-result-object v9

    invoke-virtual {v9}, Lcom/android/internal/telephony/Phone$State;->ordinal()I
    ...
    .line 768
    :cond_5
    const-string/jumbo v8, "voipWifiCalling=off"
    ...
    const-string/jumbo v10, "realcall=on in case of "
    ...
    .line 673
    const-string/jumbo v8, "realcall=on"
    ...
    const-string/jumbo v10, "realcall=off in case of "
    ...
    .line 676
    const-string/jumbo v8, "realcall=off"
    ...
    invoke-virtual {v0, v8, v9}, Landroid/media/AudioManager;->requestAudioFocusForCall(II)V

    .line 698
    const/4 v8, 0x1

    iput-boolean v8, p0, Lcom/android/internal/telephony/CallManager;->mAudioFocusForCall:Z
    ...
    .line 704
    .end local v6           #ringingPhone:Lcom/android/internal/telephony/Phone;
    :pswitch_1
    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->getFgPhone()Lcom/android/internal/telephony/Phone;
    ...
    const-string/jumbo v9, "setAudioMode Set audio mode for video call!"
    ...
    const-string/jumbo v9, "setAudioMode Set audio mode for SIP call!"
    ...
    iget-boolean v8, p0, Lcom/android/internal/telephony/CallManager;->mAudioFocusForCall:Z
