...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;Z)V
    ...
    .line 206
    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mPrevSs:Landroid/telephony/ServiceState;
    ...
    .line 259
    const-string/jumbo v0, "vm_sim_imsi_key"
    ...
    invoke-virtual {p0, p0, v0, v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->registerForServiceStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private handleCfuQueryResult([Lcom/android/internal/telephony/CallForwardInfo;)V
    ...
    const-string v6, "handleCfuQueryResult() called when mIccRecords is null."
...
.method private onIncomingUSSD(ILjava/lang/String;)V
    ...
    .line 1918
    .restart local v0       #erroCode:I
    :cond_6
    invoke-virtual {v1, v0}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->onUssdFinishedError(I)V
...
.method private updateCallForwardStatus(I)V
    ...
    const-string v3, "info is present on sim"
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    .line 1008
    .local v9, newDialString:Ljava/lang/String;
    move-object/from16 v0, p0

    invoke-direct {v0, v9}, Lcom/android/internal/telephony/gsm/GSMPhone;->processUkCliPrefix(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    .line 1014
    const-string v1, "com.android.phone.emergency_call_notification_pref"

    .line 1015
    .local v1, ECN_PREFS_NAME:Ljava/lang/String;
    const-string v3, "ecn_ussd"

    .line 1016
    .local v3, USSD_KEY:Ljava/lang/String;
    const-string v2, "ecn_sent"

    .line 1018
    .local v2, ECN_SENT_KEY:Ljava/lang/String;
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getContext()Landroid/content/Context;

    move-result-object v12

    const-string v13, "com.android.phone.emergency_call_notification_pref"
    ...
    .line 1020
    .local v5, ecnUSSD:Ljava/lang/String;
    const-string v12, "ecn_sent"
    ...
    .line 1046
    .local v8, networkPortion:Ljava/lang/String;
    move-object/from16 v0, p0

    invoke-virtual {v0, v9}, Lcom/android/internal/telephony/gsm/GSMPhone;->handleInCallMmiCommands(Ljava/lang/String;)Z
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mUiccApplication:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v12}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Lcom/android/internal/telephony/uicc/UiccCardApplication;

    move-object/from16 v0, p0

    invoke-static {v8, v0, v12}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->newFromDialString(Ljava/lang/String;Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/uicc/UiccCardApplication;)Lcom/android/internal/telephony/gsm/GsmMmiCode;
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCT:Lcom/android/internal/telephony/gsm/GsmCallTracker;

    move-object/from16 v0, p2

    invoke-virtual {v12, v9, v0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    .line 1066
    :cond_2
    invoke-virtual {v6}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->isTemporaryModeCLIR()Z
    ...
    iget-object v13, v6, Lcom/android/internal/telephony/gsm/GsmMmiCode;->dialingNumber:Ljava/lang/String;

    invoke-virtual {v6}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->getCLIRMode()I

    move-result v14

    move-object/from16 v0, p2

    invoke-virtual {v12, v13, v14, v0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    .line 1071
    .local v7, moConnection:Lcom/android/internal/telephony/gsm/GsmConnection;
    ...
    .line 1072
    iput-object v9, v7, Lcom/android/internal/telephony/gsm/GsmConnection;->dialString:Ljava/lang/String;
    ...
    iget-object v13, v7, Lcom/android/internal/telephony/gsm/GsmConnection;->address:Ljava/lang/String;
    ...
    iput-object v12, v7, Lcom/android/internal/telephony/gsm/GsmConnection;->address:Ljava/lang/String;

    goto :goto_0

    .line 1077
    .end local v7           #moConnection:Lcom/android/internal/telephony/gsm/GsmConnection;
    :cond_3
    move-object/from16 v0, p0
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mPendingMMIs:Ljava/util/ArrayList;
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mMmiRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-direct {v13, v14, v6, v15}, Landroid/os/AsyncResult;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Throwable;)V

    invoke-virtual {v12, v13}, Landroid/os/RegistrantList;->notifyRegistrants(Landroid/os/AsyncResult;)V

    .line 1085
    invoke-virtual {v6}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->processCode()V
...
.method public getSMSavailable()Z
    ...
    .line 2955
    iget-boolean v1, v0, Lcom/android/internal/telephony/uicc/IccRecords;->isAvailableSMS:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getUiccCard()Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/telephony/uicc/UiccCard;->getCatService()Lcom/android/internal/telephony/cat/CatService;

    move-result-object v23

    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/telephony/cat/CatService;->UssdSendByStk()Z

    move-result v13

    .line 2167
    .local v13, mUssdSentByStk:Z
    const-string v23, "GSM"
    ...
    const-string v25, "mUssdSentByStk : "
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/internal/telephony/cat/CatService;->SetUssdFlag(Z)V

    goto/16 :goto_0

    .line 2176
    .end local v13           #mUssdSentByStk:Z
    :cond_3
    ...
    const-string/jumbo v24, "setVoiceCallForwardingFlag() aborted. icc absent?"
    ...
    const-string v24, "Sim card is absent."
    ...
    const-string v24, "Stop duplicate SET_NETWORK_SELECTION_AUTOMATIC to Ril "
    ...
    invoke-direct {v14, v0, v1}, Lcom/android/internal/telephony/gsm/GsmMmiCode;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/uicc/UiccCardApplication;)V

    .line 2313
    .local v14, mmi:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    invoke-virtual {v14, v5}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->processSsData(Landroid/os/AsyncResult;)V
    ...
    .line 2319
    .local v8, eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    move-object/from16 v0, p1
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/internal/telephony/uicc/SIMRecords;->getEonsForAvailableNetworks(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    const-string v24, "getEonsForAvailableNetworks() aborted. icc absent?"
    ...
    const-string v24, "[EONS] Populated EONS for available networks."
    ...
    .end local v8           #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    check-cast v8, Ljava/util/ArrayList;

    .restart local v8       #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    goto :goto_6
    ...
    const-string v24, "[EONS] In EVENT_GET_NETWORKS_DONE, onComplete is null!"
    ...
    const-string v24, "Error while fetching Mdn"
    ...
    const-string v24, "Event EVENT_SUBSCRIPTION_READY received"
    ...
    const-string v24, "Error while fetching Prl"
    ...
    const-string v24, "Service state changed"
...
.method public onUpdateIccAvailability()V
    ...
    .line 2428
    :cond_1
    const-string/jumbo v2, "onUpdateIccAvailability"
...
.method public requestIsimAuthentication(Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v1, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->requestIsimAuthentication(Ljava/lang/String;Landroid/os/Message;)V
    ...
    .end local v0           #r:Lcom/android/internal/telephony/uicc/IccRecords;
    invoke-virtual {v0, p1, p2}, Lcom/android/internal/telephony/uicc/SIMRecords;->requestIsimAuthentication(Ljava/lang/String;Landroid/os/Message;)V
...
.method public setEmergencyNumbers(Ljava/lang/String;)V
    ...
    const-string/jumbo v18, "setEmergensetEmergencyNumberscyNumbers: customerSpec="
